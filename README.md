...
- 连续确认“本人 + 第二个人”后立即覆盖屏幕工作区毛玻璃；甩动鼠标可立即恢复，第二个人离开且只剩本人满 3 秒也会自动恢复；
...
- **持续监测**：保持原有行为，在 Windows 解锁期间持续使用摄像头；可配合“仅本人”模式启用多人脸隐私模糊。
...
本功能仅在“持续监测 + 仅本人”模式下生效，默认开启。系统连续两帧确认画面中同时存在已注册本人和
...
方向反转，普通的单向快速移动不会误解除。如果没有甩动鼠标，当系统连续确认画面
只剩已注册本人满 3 秒，也会自动解除毛玻璃；只剩一张陌生人脸不会自动解除，第二
个人再次出现、摄像头读取失败或模型推理异常都会重新计算这 3 秒。
