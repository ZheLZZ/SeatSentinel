...
AwayLock 使用下列第三方软件或模型。本文件用于说明直接依赖及其许可来源，
不替代各项目随附的完整许可证文本。

| Component | Purpose | License |
| --- | --- | --- |
| [OpenVINO](https://github.com/openvinotoolkit/openvino) | 本地模型推理及 NPU/CPU 设备支持 | Apache-2.0 |
| [OpenVINO Telemetry](https://pypi.org/project/openvino-telemetry/) | OpenVINO 的可选工具依赖；AwayLock 不初始化其遥测 | Apache-2.0 |
...
AwayLock 自有源代码采用项目根目录 `LICENSE` 中的 MIT License。第三方软件
